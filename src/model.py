...
#         self.conv1 = nn.Conv2d(1, 16, 3, dilation=1)  ## inchannel , outchannel , kernel size ..
#         self.conv1_bn = nn.BatchNorm2d(16)

#         self.conv2 = nn.Conv2d(16, 32, 5, dilation=2)
#         self.conv2_bn = nn.BatchNorm2d(32)

#         self.conv3 = nn.Conv2d(32, 64, 5, dilation=4)
#         self.conv3_bn = nn.BatchNorm2d(64)

#         # self.conv4 = nn.Conv2d(64, 64, 7, dilation=8)
#         # self.conv4_bn = nn.BatchNorm2d(64)

#         self.fc1 = nn.Linear(64 * 21 * 161, 32)
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 24, 5, dilation=1, stride=1)   # inchannel , outchannel , kernel size ..
...
class WaveNet(nn.Module):
    def __init__(self, hyperparams: dict, in_channels: int):
        ...
        self.dilation_factors = [2 ** i for i in range(0, hyperparams['nb_layers'])] ## ( 2^0 , 2^1 , 2^2 , 2^3 )

        self.in_channels = [in_channels] + [hyperparams['nb_filters'] for _ in range(hyperparams['nb_layers'])] ## [1 , 8 ,8 ,8 ,8  ]
